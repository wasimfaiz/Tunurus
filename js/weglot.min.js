var Weglot = (function () {
  ...
  function a(e) {
    var t = e.service;
    function n(e, n, a) {
      var i = a.sendToConsole;
      void 0 === i && (i = !0);
      var c = a.consoleOverride,
        s = a.sendToDatadog;
      if (
        (void 0 === s && (s = !0),
        s &&
  ...
  var i = a({ service: "html-parser-engine" });
  function c(e, t, n) {
    var r = t && t[e];
    if (r && r.textContent === t.textContent) return r.result;
    var o = n(t);
    return t ? ((t[e] = { result: o, textContent: t.textContent }), o) : o;
  }
  function s(e) {
      ...
      return (
        ...
        !(function (e) {
          return c("__containsNoTranslateNodes", e, function (e) {
            return (
              1 === e.nodeType &&
              (!!e.querySelector("[" + n.noTranslateAttribute + "]") || d(e))
            );
          });
        })(e)
      );
  ...
  function d(e) {
    ...
    for (var t = 0, n = e.children; t < n.length; t += 1) {
      var r = n[t];
      if (r.wgNoTranslate || d(r)) return !0;
    }
    return !1;
  }
  function _(e) {
  ...
  function g(e) {
    ...
    return (
      !!(t && t.closest && t.closest("[" + n.noTranslateAttribute + "]")) ||
      _(e)
    );
  }
  var p = function (e, t) {
  ...
  function y(e) {
    ...
    if (
      ...
      return [].concat(
        (function (e) {
          ...
          return e === document.documentElement && document.title && t && !g(t)
            ? [
                {
    ...
    var r = n.whitelist
      ...
      .join(",");
    if (t.closest && t.closest(r)) return w(t);
              ...
              var r,
                ...
                u =
                  ...
                  r.childElementCount > 0 &&
                    o.push.apply(o, r.querySelectorAll(a)),
                  o);
              l < u.length;
              l += 1
            ) {
      ...
      (function (e) {
        for (
          var t,
            ...
            a = document.createTreeWalker(e, 4, b, !1);
          (t = a.nextNode());

        ) {
          var i = (
            o && (u(t.parentNode) || t.parentNode.childNodes.length > 1) ? k : E
          )(t, a);
          i && r.push(i);
        }
        return r;
  ...
  function b(e) {
    return !l(e) || g(e) ? NodeFilter.FILTER_REJECT : NodeFilter.FILTER_ACCEPT;
  }
  function k(e, t) {
    var r = (function (e) {
    ...
    if (r && v.has(r)) {
      var o = v.get(r);
      return { element: o[0], words: o[1], type: 1, properties: o[2] };
    }
    var a = (function (e, t) {
      for (var r = [], o = e; s(e.parentNode); )
        (e = e.parentNode),
          o.textContent.trim() !== e.textContent.trim() && (o = e);
      for (
    ...
    if (a) {
      var i = a[0],
        ...
        l = a[2];
      if (!x(c))
        return v.set(i, a), { element: i, words: c, type: 1, properties: l };
    }
  }
  function E(e) {
    var t = e.textContent;
    if (!x(t)) return { element: e, words: t, type: 1, properties: {} };
  }
  function S(e, t) {
    if (e.childNodes)
  ...
  function C(e, t) {
    for (var n = 0, r = e; n < r.length; n += 1) {
      var o = r[n],
        a = o.weglot.content;
      if (a && o.isConnected) {
        for (var i = 0, c = a; i < c.length; i += 1) {
          var s = c[i],
            l = s.original,
            u = s.properties,
            f = s.attrSetter,
            d = s.translations[t] || l;
          u && ((o.weglot.setted = !0), O(o, d, u, e)),
            f && ((o.weglot.setted = !0), f(o, d, l));
        }
        o.wgResolved = !1;
      }
    }
    ...
    if (-1 !== t.indexOf("<") && -1 !== t.indexOf(">")) {
      if (!e.parentNode)
        return (
          ...
          void i.warn(e, { sendToDatadog: !1 })
        );
      if (1 === e.parentNode.childNodes.length)
        return (
          (e.parentNode.weglot = e.weglot),
          void (r ? r.push(e.parentNode) : O(e.parentNode, t, n))
        );
      var a =
      ...
      if (!a || a.innerHTML !== t) {
        ...
        (c.dataset.wgTranslationWrapper = ""),
          (c.weglot = e.weglot),
          e.parentNode.replaceChild(c, e),
          r ? r.push(c) : O(e.parentNode, t, n);
      }
  ...
  function P(e) {
    var t = [
      { type: 1, selectors: ["[title]"], attribute: L("title") },
      {
        type: 2,
      ...
      { type: 7, selectors: ["img"], attribute: L("alt") },
      {
        type: 8,
    ...
    if (
      (e.media_enabled &&
        t.push(
          ...
          { type: 6, selectors: ["img"], attribute: L("srcset") }
        ),
      e.translate_aria &&
        t.push({
          type: 1,
          selectors: ["[aria-label]"],
          attribute: L("aria-label"),
        }),
      e.external_enabled)
    ) {
      var n = j(
        (function () {
          ...
          return r
            ? r[1]
            : (i.warn("[Weglot] Unable to get current hostname"), t);
        })()
      );
      t.push(
        { type: 10, selectors: ["iframe"], attribute: L("src") },
        { type: 10, selectors: ["a[rel=external]"], attribute: L("href") },
        { type: 10, selectors: ['[href^="mailto"]'], attribute: L("href") },
        { type: 10, selectors: ['[href^="tel"]'], attribute: L("href") },
        {
          type: 10,
          ...
          attribute: {
            ...
            get: function (e) {
              ...
              return t && j(t) !== n ? e.getAttribute("href") : "";
            },
            set: function (e, t) {
  ...
  b.acceptNode = b;
  var D = [];
  var R = a({ service: "js-library" }),
    I = "wglang",
    W = "wg-style-trans",
    U = "data-wg-notranslate",
    M = "ve-weglot.com",
    q = "wg-translations",
    H = "wg-slugs",
    B = "Shopify",
    ...
    V = ["none", "shiny", "square", "circle", "rectangle_mat"],
    G = [
  ...
  var Y = J.URL,
    ...
    X = K("querySelectorAll", []),
    Z = K("querySelector", null),
    Q = K("closest", null),
    ee = function (e) {
  ...
  (ge.set = function (e, t, n, r, o) {
    ce &&
      ...
      !n && et.is_connect && et.subdomain && (n = et.host.split("www.").pop()),
      (n = n ? ";domain=" + n : ""),
      (o = o ? ";expires=" + o : ""),
      (r = r || ""),
      (document.cookie =
        e + "=" + t + n + ";path=/" + r + o + ";SameSite=None;Secure"));
  }),
    (ge.get = function (e) {
      if (!ce) return null;
    ...
    (ge.erase = function (e, t, n) {
      ge.set(e, "", t, n, "Thu, 01 Jan 1970 00:00:00 GMT");
    });
  var pe = [];
  function me(e, t, n) {
    if (e) return n();
  ...
  function he(e, t, n) {
    return "function" != typeof t
      ? (R.error("You should provide a callback function as second argument", {
          sendToDatadog: n,
        }),
        !1)
      : !n && F.indexOf(e) < 0
      ? (R.error("No Weglot event is named " + e, { sendToDatadog: !1 }), !1)
      : (pe.push({ name: e, callback: t, internal: n }), !0);
  }
  function ve(e) {
    for (var t = [], n = arguments.length - 1; n-- > 0; )
      t[n] = arguments[n + 1];
    for (
      var r = pe.filter(function (t) {
          return t.name === e;
        }),
        o = 0,
        a = r;
      ...
      try {
        ...
        R.error("Error triggering callback function: " + e, {
          sendToDatadog: !1,
        });
      }
    }
  ...
  function ye() {
    if (window.location.hostname !== M || !document.baseURI) {
      var e = window.location;
      return {
        url: e.href,
        hostname: e.hostname,
    ...
    var t = new Y(document.baseURI),
      n = t.hostname,
      r = t.pathname,
      o = t.search;
    return { url: document.baseURI, hostname: n, pathname: r, search: o };
  }
  var we = ye();
  me(et && Object.keys(et).length > 0, "onOptionsReady", function () {
    if (et.dynamicPushState) {
      var e = history.pushState;
      history.pushState = function () {
        for (var t = [], n = arguments.length; n--; ) t[n] = arguments[n];
        e.apply(history, t);
        var r = ye();
        (we.hostname = r.hostname),
          (we.pathname = r.pathname),
          ve("onCurrentLocationChanged");
      };
    }
  });
  var be,
          ...
          var f = u[r + 1],
            d = n.find(function (e) {
              var t = e.custom_code || e.language_to,
                n = a.replace("CODE", t),
                r = new RegExp("^" + n + "$", "g");
              return !!r.test(f) && ((s = r), !0);
            });
          if (d) return (c = d.custom_code || d.language_to), !0;
          if (i) {
            var _ = i.replace("CODE", o);
            return new RegExp("^" + _ + "$", "g").test(f);
          }
          return !l;
        }) || r;
    return (
      (ke.convertLocale = function (t, n, r, a) {
        if (
          (void 0 === n && (n = e),
          void 0 === r && (r = c || o),
          void 0 === a && (a = null),
        ...
        var _ = d[i + 1];
        if (r === o) {
          var g = f.replace(/CODE/g, t),
            p = !1;
          if (u) {
            var m = u.replace(/CODE/g, o),
              h = new RegExp("^" + m + "$", "g"),
              v = Ee(g);
            (g = _.replace(h, v)),
              a && !h.test(_) && ((p = !0), (g = a.split("/")[i + 1]));
          }
          var y = u && !p ? 2 : 1;
          return d
            .slice(0, i + 1)
            .concat([g], d.slice(i + y))
            .join("/");
        }
        if (t === o && !u)
          return d
            ...
            .concat(d.slice(i + 2))
            .join("/");
        var w = Ee((t === o ? u : f).replace(/CODE/g, t)),
          b = _.replace(s, w);
        return d
          .slice(0, i + 1)
  ...
  function xe() {
    var e = we.hostname,
      t = et.languages.find(function (t) {
        return (
          t.connect_host_destination && t.connect_host_destination.host === e
        );
      });
    return t ? t.custom_code || t.language_to : et.language_from;
  }
  function Ce() {
    return Se().language;
  }
  function Oe() {
    ...
    if (et.is_connect) {
      ...
      return e ? ((be = e), e) : (be = et.subdirectory ? Ce() : xe());
    }
    return (be = et.language_from);
  }
  function Ne(e, t) {
    var n = t;
    n || (n = Oe());
  ...
  function Ae(e) {
    ...
    var t = e.type || "local";
    try {
      return "cookie" === t ? Te : window.localStorage;
    } catch (e) {}
    return e.type ? Le : Ae({ type: "local" === t ? "cookie" : "local" });
  }
  var je = { slugs: {}, version: 0, network: void 0 };
  function Pe(e) {
    return e
  ...
  function De(e) {
    ...
    if (t && t.slugTranslation) {
      ...
      je.version < n &&
        (je.network
          ? je.network.resolved ||
            je.network.then(function (t) {
              return e(Pe(t));
            })
          : (je.network = new Promise(function (e) {
              for (
                var t = et.languages,
                  n = {},
                  r = function () {
              ...
              .then(function (t) {
                return (
                  (je.network.resolved = !0),
                  (function (e) {
                    var t = et.versions,
                      n = { version: t ? t.slugTranslation : 1, slugs: e };
                    try {
                      var r = Ae({ type: "local" });
                      r && r.setItem(H, JSON.stringify(n));
                    } catch (e) {
                      R.warn(e);
                    }
                    je = Object.assign({}, je, n);
                  })(t),
                  e(Pe(t)),
                  t
                );
  ...
  !(function () {
    if (Object.keys(je.slugs).length) return je.slugs;
    try {
      var e = Ae({ type: "local" });
      if (!e) return {};
      var t = e.getItem(H);
      t && (Object.assign(je, JSON.parse(t)), je.slugs);
    } catch (e) {
      return {};
    }
  })();
  ...
  function Ue(e, t) {
    if (!et.is_connect || !e) return t("#");
    var n = et.injectedData;
    void 0 === n && (n = {});
    var r = n.allLanguageUrls;
    if ((void 0 === r && (r = {}), r && r[e])) {
      var o = new Y(r[e]);
      return We(e, o), t(o.toString());
    }
    De(function (n) {
      return t(
        (function (e, t) {
          var n = Oe(),
            r = new Y(we.url);
          r.searchParams.has("lang") && r.searchParams.delete("lang"), We(e, r);
          var o = (function (e) {
            if (et.subdirectory) return !1;
            var t = et.language_from,
              n = et.host,
              r = et.languages;
            if (e === t) return n;
            var o = (
          ...
          return (
            ...
            (r.pathname = (function (e, t, n, r) {
              ...
              if (!Re.originalPath)
                if (n !== et.language_from && e[n]) {
                  var o = e[n].translated;
                  Re.originalPath = Ie(t, o);
                } else Re.originalPath = t;
              return r === et.language_from
                ? Re.originalPath
                : e[r] && e[r].original
                ? Ie(Re.originalPath, e[r].original)
                : t;
            })(t, r.pathname, n, e)),
            et.subdirectory &&
              e &&
              (r.pathname = (function (e, t) {
                return Se().convertLocale(e, t);
              })(e, r.pathname)),
            r.toString()
          );
        })(e, n)
  ...
  function He() {
    ...
    if (e) {
      ...
      (1 !== t.length && t[0] === t[1]) || ge.set("cart", t[0], qe());
    } else setTimeout(He, 100);
  }
  function Be(e, t) {
    return et.is_connect && e !== et.language_from
      ? Me[t]
        ? Me[t]
        : (De(function (r) {
            var o = r && r[e] ? Ie(t, r[e].original) : t;
            n = et.subdirectory
              ? Se().convertLocale(e, o, et.language_from)
              : o;
          }),
          (Me[t] = n),
          n)
  ...
  he(
    ...
    de("onWeglotSetup", function () {
      et.original_shopify_checkout &&
        et.is_connect &&
        !et.subdirectory &&
        et.language_from === Oe() &&
        He();
  ...
  function $e(e, t) {
    if ((void 0 === t && (t = ""), !e)) return $.button_style;
    var n = e.classF || "",
      r = n.match(/flag-(\d)/),
      o = {
  ...
  function Ve(e) {
    var t = e.styleOpt,
      ...
      r = e.target,
      o = e.sibling;
    return { style: $e(t, n), location: { target: r, sibling: o } };
  }
  (ze[B] = function () {
    var e = function (e) {
        void 0 === e && (e = Oe());
        for (
          ...
          var i = a[o],
            c = i.getAttribute("action");
          (0 === c.indexOf(t("/cart")) && c.split("?")[0] !== t("/cart")) ||
            i.setAttribute("action", se(c, "locale", r));
        }
        for (
          var s = 0,
          ...
          var u = l[s];
          u.setAttribute("href", se(u.getAttribute("href"), "locale", r));
        }
      },
      t = function (e) {
        void 0 === e && (e = Oe());
        var t =
          ...
          document.querySelector('form[action="' + Be(e, "/account") + '"]') ||
          ("string" == typeof et.customer_tag && Z(document, et.customer_tag));
        if (t) {
    ...
    var r = function (e) {
      if (
        (void 0 === e && (e = Oe()),
        !et.visual_editor && window.top === window.self)
      ) {
        var t = et.cart_attributes
            .map(function (t) {
        ...
        et.original_shopify_checkout &&
          ...
          r
            ...
            .then(function (e) {
              var t = e.token;
              return ge.set("cart", t, qe());
            });
        for (
          var o = document.querySelectorAll('a[href*="/cart/"]'),
            a = "attributes[lang]=" + e,
            i = 0,
            c = o;
          i < c.length;
          ...
          if (l) {
            var u = l.match(/\/cart\/\d+:\d+(\?)?/);
            u &&
              ((l = l.replace(/&?attributes\[lang\]=([a-zA-Z-]+)/g, "")),
              s.setAttribute("href", l + (u[1] ? "&" : "?") + a));
          }
        }
      }
    };
    function o(o) {
      if (et.language_from !== o) {
        var a, i;
        window.Shopify && (window.Shopify.locale = o),
          ...
          (i = (function () {
            ...
            return t ? t[1] : null;
          })()) && ge.set("checkout_locale", n(a), null, i);
        var c = document.querySelectorAll("[data-wg-only-display]");
        c.length && Ne(c, o), et.customer_tag && t(o);
      }
    }
    he(
      "initialized",
      function () {
        window.langify &&
          R.log("%c Please, uninstall langify to properly use Weglot", {
            sendToDatadog: !1,
          }),
          ae() ||
            !et.order_tag ||
            (et.is_connect && et.language_from !== Oe()) ||
            r(),
          e();
        var o,
              ...
              if ("/wallets/checkouts.json" === arguments[0])
                try {
                  ...
                  (e.checkout.attributes = {}),
                    et.cart_attributes.forEach(function (n) {
      ...
      de("onConnectPageLoad", function (e) {
        return o(e);
      }),
      de("onPageLanguageSet", function (e) {
        return o(e);
      }),
      de("onDynamicDetected", function () {
        e(Oe());
      }),
      de("startWhen", function () {
        return (
          ee("admin-bar-iframe") ||
          ee("preview-bar-iframe") ||
          et.private_mode ||
          (function () {
    ...
    var a = [".shopify-payment-button button"]
      .concat([
        ...
        de("onPageLanguageSet", function (e) {
          !(function (e) {
            for (
              ...
              var r = n[t];
              r.setAttribute("href", se(r.getAttribute("href"), "lang", e));
            }
          })(e);
        }),
        {
    ...
    (ze.Bubble = function () {
      return et.is_connect ? {} : { dynamics: [{ value: ".content" }] };
    }),
    (ze.Jimdo = function () {
      return {
        excluded_blocks: [
    ...
    (ze.Squarespace = function () {
      ...
      return {
        ...
        excluded_blocks: t
          ...
          .concat(et.is_connect ? [{ value: ".comment-body" }] : []),
  ...
  var Ge = [
    ...
    { from: "exceptions", to: "excluded_blocks", func: Fe },
    { from: "whiteList", to: "whitelist", func: Fe },
    { from: "styleOpt", to: "button_style", func: $e },
    {
    ...
    return (
      t.switchers &&
        ...
        t.switchers.length &&
          ...
          (t.switchers = t.switchers.map(Ve))),
  ...
  function Xe(e) {
    ...
    return (function (e) {
      ...
      return fetch(
        "https://cdn.weglot.com/projects-settings/" + e + ".json"
      ).then(function (e) {
        return e.json();
      });
    })(t)
      .then(function (e) {
        ...
        var i = Qe(Object.assign({}, r, t, n));
        return ve("onOptionsReady"), i;
      })
      .catch(function (e) {
        R.error(e, {
          consoleOverride:
  ...
  function Ze() {
    var e = ee("weglot-data");
    if (e)
      try {
        var t = JSON.parse(e.innerHTML);
        delete t.settings, t && (Ke.injectedData = t);
      } catch (e) {}
  }
  function Qe(e) {
    if (e.deleted_at)
    ...
    e.injectedData ||
      ...
      (e.subdomain = !e.subdirectory && (e.subdomain || Ke.is_connect)),
      e.dynamic &&
        (e.dynamics ||
        ...
        delete e.dynamic),
      window.location.hostname === M && (Ke.visual_editor = !0),
      ((function () {
        -1 !== location.search.indexOf("weglot-private=0") &&
          Ae().removeItem("wg-private-mode");
        var e =
          ...
          "1" === Ae().getItem("wg-private-mode");
        return e && Ae().setItem("wg-private-mode", "1"), e;
      })() ||
        Ke.switcher_editor ||
        Ke.visual_editor) &&
        (Ke.private_mode = !0);
    var t,
      n,
      r = (t = e.technology_name || Ke.technology_name) && ze[t] ? ze[t]() : {},
      o = Object.assign({}, $, r);
    if (
      (Object.assign(Ke, o, e),
      ...
      (n.type = "text/css"),
      (n.href = "https://cdn.weglot.com/weglot.min.css?v=4"),
      document.head.appendChild(n),
      Ke.button_style &&
        Ke.button_style.custom_css &&
        oe(Ke.button_style.custom_css, "weglot-custom-style"),
      Ke.switchers && 0 !== Ke.switchers.length
        ? (Ke.switchers = Ke.switchers.map(function (e) {
            var t = e.button_style,
              n = Ye(e, ["button_style"]);
            return Object.assign({}, { style: n.style || t }, n);
          }))
        : (Ke.switchers = [
            { style: Ke.button_style, location: {}, default: !0 },
          ]),
      Ke.cache && Ke.visual_editor && (Ke.cache = !1),
      Ke.api_key.length < 36 && (Ke.translation_engine = 1),
      Ke.excluded_blocks_remove &&
        (Ke.excluded_blocks = Ke.excluded_blocks.filter(function (e) {
          return !Ke.excluded_blocks_remove.includes(e.value);
        })),
      Ke.dangerously_force_dynamic &&
        (Ke.dynamics = Ke.dynamics.concat(
          Ke.dangerously_force_dynamic.split(",").map(function (e) {
            return { value: e.trim() };
          })
        )),
      (Ke.excluded_blocks = Ke.excluded_blocks.filter(function (e) {
      ...
      (Ke.dynamics = Ke.dynamics.filter(function (e) {
        return ie(e.value);
      })),
      Ke.dynamics_remove &&
        (Ke.dynamics = Ke.dynamics.filter(function (e) {
          return !Ke.dynamics_remove.includes(e.value);
        })),
      (Ke.is_tld = !1),
      r.forceDisableConnect && (Ke.is_connect = !1),
      Ke.is_connect)
    ) {
      var a = Ke.host.split("www.").pop();
      Ke.is_tld = Ke.languages.some(function (e) {
        if (e.connect_host_destination && e.connect_host_destination.host)
          return -1 === e.connect_host_destination.host.indexOf(a);
      });
    }
    return Ke;
  }
  ...
  function at(e) {
    if (e && e.toLowerCase) {
      var t = e.toLowerCase(),
        n = et.languages.find(function (e) {
          var n = e.language_to,
            r = e.custom_code;
  ...
  !(function (e) {
    ...
    var t = Object.keys(tt).filter(function (e) {
      return !tt[e];
    });
    t.length
      ? (function (e, t, n) {
  ...
  function st(e) {
    ...
    var r = e || at(Oe());
    return (
      (void 0 !== ct[r] && ct.currentLang === r) ||
        ((ct.currentLang = r),
        et.injectedData &&
          et.injectedData.originalPath &&
          (n = et.injectedData.originalPath.toLowerCase()),
        t.some(function (e) {
          var t = e.type,
            o = e.value,
          ...
          var s = {
            ...
            allExcluded: !(
              !a || !(0 === a.length || a.length >= et.languages.length)
            ),
          };
          ...
          var l,
            u =
              ((l = n),
              {
                START_WITH: function (e) {
                  return 0 === l.indexOf(e);
                },
                END_WITH: function (e) {
                  return -1 !== l.indexOf(e, l.length - e.length);
                },
                CONTAIN: function (e) {
                  return -1 !== l.indexOf(e);
                },
                IS_EXACTLY: function (e) {
                  return l === e;
                },
                MATCH_REGEX: function (e) {
                  try {
                    return new RegExp(e, "i").test(l);
                  } catch (t) {
                    return (
                      R.warn(t, {
                        consoleOverride: e + " is an invalid regex",
                        sendToDatadog: !1,
                      }),
                      !1
                    );
  ...
  function lt() {
    ...
    if (!et.api_key)
      return (
        R.warn("Weglot must be initialized to use it.", { sendToDatadog: !1 }),
        []
      );
    var e = (et.languages || [])
        .filter(function (e) {
          var t = st(e.language_to),
            n = !t || t.language_button_displayed;
          return (
            (!1 !== e.enabled || et.private_mode) &&
            n &&
            (et.subdirectory ||
              !e.connect_host_destination ||
              e.connect_host_destination.created_on_aws)
      ...
      t = [et.language_from].concat(e);
    return (
      (it = t.filter(function (e, n) {
        return t.indexOf(e) == n;
      })),
      e.length || R.log("No public language available.", { sendToDatadog: !1 }),
      it
    );
  }
  he(
  ...
  function ft(e) {
    ...
    for (var t = {}, n = {}, r = 0, o = e; r < o.length; r += 1) {
      var a = o[r],
        i = a.toLowerCase(),
        c = i.substring(0, 2);
      t[c] || (t[c] = []), t[c].push(i), (n[i] = a);
    }
    for (
      var s = 0, l = navigator.languages || [navigator.language];
      s < l.length;
      s += 1
    ) {
      var u = l[s],
        ...
        d = f.substring(0, 2);
      if (n[f]) return n[f];
      for (var _ = 0, g = ut; _ < g.length; _ += 1) {
        var p = g[_],
          m = p.codes,
          h = p.pattern,
          v = m.find(function (t) {
  ...
  var dt = function () {
    ...
    if (
      !(
        ...
        et.subdirectory ||
        e ||
        Ae({ type: "cookie" }).getItem("WG_CHOOSE_ORIGINAL") ||
        ae() ||
        et.visual_editor
      )
    ) {
      ...
      return t && !st(t)
        ? t
        : et.auto_switch_fallback && !st(et.auto_switch_fallback)
  ...
  function _t(e) {
    if (e === et.language_from) {
      var t = new Date();
      t.setTime(t.getTime() + 2592e6),
        Ae({ type: "cookie" }).setItem("WG_CHOOSE_ORIGINAL", "1", {
          expires: t.toUTCString(),
        });
    } else Ae({ type: "cookie" }).removeItem("WG_CHOOSE_ORIGINAL");
  }
  var gt = function (e) {
    var t = et.api_key;
  ...
  function pt() {
    var e = Ae().getItem(I);
    if (e && lt().includes(e)) return e;
  }
  var mt = function (e) {
    return e && Ae().setItem(I, e);
  };
  function ht() {
    te(ee(W));
  }
  ...
  var St = function () {
      return wt && kt.setItem(q, JSON.stringify(wt));
    },
    xt = [];
  function Ct(e, t) {
      ...
      .map(
        (function (e) {
          return function (t) {
            ...
            if (i) {
              var _ = l.content.find(function (e) {
                  return e.attrSetter === i;
                }),
                g = { attrSetter: i, original: r, type: o, translations: u };
              _ ? Object.assign(_, g) : l.content.push(g);
            }
            return n;
          };
        })(n)
  ...
  function Tt(e, t) {
    ...
    for (var n = [], r = {}, o = 0, a = e; o < a.length; o += 1)
      for (var i = 0, c = a[o].weglot.content; i < c.length; i += 1) {
        var s = c[i],
          l = s.original,
          u = s.type;
        r[l] || ((r[l] = !0), n.push({ t: u, w: l, l: t.label }));
      }
    return n;
  }
  function Lt(e, t, n) {
    if (
      ...
      for (
        var r = e.from_words, o = e.to_words, a = 0, i = n;
        a < i.length;
        a += 1
      )
        for (var c = 0, s = i[a].weglot.content || {}; c < s.length; c += 1) {
          var l = s[c],
            u = l.original,
            f = l.translations,
            d = r.indexOf(ne(u));
        ...
        ((n = (function (e, t) {
          ...
          return (
            e.forEach(function (e) {
              var a = Et(e.w);
              a && a[t] ? (n.push(a[t]), r.push(ne(e.w))) : o.push(e);
            }),
            { cachedWords: { to_words: n, from_words: r }, newWords: o }
          );
        })(o, r)),
        (i = n.newWords),
        ...
        [].push.apply(
          ...
          (function () {
            ...
            return Object.keys(wt)
              .filter(function (t) {
                return wt[t].createdTime + 216e5 < e;
              })
              .map(function (e) {
                return { t: wt[e].t, w: e };
              });
    ...
    return i.length
      ? ((e.words = i),
        (e.request_url = (function () {
          var e = (function () {
            if (et.visual_editor) return new Y(we.url);
            var e = et.technology_name,
              t = et.injectedData;
            if ("Wix" === e) return new Y(window.location.href);
            if (t && t.originalCanonicalUrl)
              try {
                return new Y(t.originalCanonicalUrl);
              } catch (e) {}
            ...
            return new Y(window.location.href);
          })();
          ...
          for (
            var t = 0,
              n = vt.filter(function (e) {
                return e.condition.some(function (e) {
                  var t = e.type,
                    n = e.payload;
                  return "TECHNOLOGY_ID" === t && n === et.technology_id;
                });
              });
            t < n.length;
            t += 1
            ...
            var r = n[t].value;
            try {
              for (var o = 0, a = r; o < a.length; o += 1) {
                var i = a[o],
                  c = i.original,
                  s = i.formatted,
                  l = e.pathname.replace(new RegExp(c), s);
                if (l !== e.pathname) return (e.pathname = l), e.toString();
              }
            } catch (e) {
              R.warn(e, { consoleOverride: "Invalid URL regex, " + e.stack });
            }
          }
          return e.toString();
        })()),
        (function (e) {
          var t = (et.versions && et.versions.translation) || 1,
            n = ["api_key=" + et.api_key, "v=" + t],
            r =
              "https://" +
              (et.bypass_cdn_api ? "api.weglot.com" : "cdn-api-weglot.com") +
              "/translate?" +
              n.join("&");
  ...
  function Dt(e, t, n) {
    ...
    var r = { l_from: et.language_from, l_to: t, words: e };
    return n.title && (r.title = document.title), At(r, n);
  }
  function Rt(e, t) {
    if ("string" != typeof e || "function" != typeof t) return !1;
    var n = Oe();
    return n === et.language_from
      ? (t(e), !1)
      : (At(
          { l_from: n, l_to: et.language_from, words: [{ t: 2, w: e }] },
          { cdn: !0, search: !0 }
        )
          .then(function (e) {
  ...
  function Yt(e, t, n) {
    ...
    if (
      (arguments.length > 2 &&
        (i.children = arguments.length > 3 ? Wt.call(arguments, 2) : n),
      "function" == typeof e && null != e.defaultProps)
    )
      for (a in e.defaultProps) void 0 === i[a] && (i[a] = e.defaultProps[a]);
    return Kt(e, i, r, o, null);
  }
  function Kt(e, t, n, r, o) {
    ...
    return null == o && null != Ut.vnode && Ut.vnode(a), a;
  }
  function Xt(e) {
    return e.children;
  }
  ...
  function Qt(e, t) {
    if (null == t) return e.__ ? Qt(e.__, e.__.__k.indexOf(e) + 1) : null;
    for (var n; t < e.__k.length; t++)
      if (null != (n = e.__k[t]) && null != n.__e) return n.__e;
    return "function" == typeof e.type ? Qt(e) : null;
  }
  function en(e) {
    var t, n;
  ...
  function tn(e) {
    ((!e.__d && (e.__d = !0) && qt.push(e) && !nn.__r++) ||
      Ht !== Ut.debounceRendering) &&
      ((Ht = Ut.debounceRendering) || Bt)(nn);
  }
  function nn() {
    var e, t, n, r, o, a, i, c;
    for (qt.sort(zt); (e = qt.shift()); )
      e.__d &&
        ((t = qt.length),
        (r = void 0),
        (o = void 0),
        ...
        (c = n.__P) &&
          ...
          gn(r, a),
          a.__e != i && en(a)),
        qt.length > t && qt.sort(zt));
    nn.__r = 0;
  }
  function rn(e, t, n, r, o, a, i, c, s, l) {
    var u,
      f,
      d,
      _,
    ...
    for (n.__k = [], u = 0; u < t.length; u++)
      if (
        null !=
        (_ = n.__k[u] =
          null == (_ = t[u]) || "boolean" == typeof _ || "function" == typeof _
            ? null
            : "string" == typeof _ ||
              "number" == typeof _ ||
              "bigint" == typeof _
            ? Kt(null, _, null, null, _)
            : Array.isArray(_)
            ? Kt(Xt, { children: _ }, null, null, null)
            : _.__b > 0
            ? Kt(_.type, _.props, _.key, _.ref ? _.ref : null, _.__v)
            : _)
      ) {
        if (
          ((_.__ = n),
          (_.__b = n.__b + 1),
          null === (d = h[u]) || (d && _.key == d.key && _.type === d.type))
        )
          h[u] = void 0;
        else
          for (f = 0; f < v; f++) {
            if ((d = h[f]) && _.key == d.key && _.type === d.type) {
              h[f] = void 0;
              break;
            }
            d = null;
          }
        _n(e, _, (d = d || Ft), o, a, i, c, s, l),
          (g = _.__e),
          (f = _.ref) &&
            d.ref != f &&
            (m || (m = []),
            d.ref && m.push(d.ref, null, _),
            m.push(f, _.__c || g, _)),
          null != g
            ? (null == p && (p = g),
              "function" == typeof _.type && _.__k === d.__k
                ? (_.__d = s = on(_, s, e))
                : (s = cn(e, _, d, h, g, s)),
              "function" == typeof n.type && (n.__d = s))
            : s && d.__e == s && s.parentNode != e && (s = Qt(d));
      }
    for (n.__e = p, u = v; u--; )
      null != h[u] &&
        ("function" == typeof n.type &&
          null != h[u].__e &&
          h[u].__e == n.__d &&
          (n.__d = sn(r).nextSibling),
        mn(h[u], h[u]));
    if (m) for (u = 0; u < m.length; u++) pn(m[u], m[++u], m[++u]);
  }
  function on(e, t, n) {
  ...
  function cn(e, t, n, r, o, a) {
    ...
    if (void 0 !== t.__d) (i = t.__d), (t.__d = void 0);
      ...
      e: if (null == a || a.parentNode !== e) e.appendChild(o), (i = null);
        ...
        for (c = a, s = 0; (c = c.nextSibling) && s < r.length; s += 1)
          if (c == o) break e;
  ...
  function ln(e, t, n) {
    "-" === t[0]
      ...
      : (e[t] =
          null == n ? "" : "number" != typeof n || Vt.test(t) ? n : n + "px");
  }
    ...
    e: if ("style" === t)
      if ("string" == typeof n) e.style.cssText = n;
        ...
        if (("string" == typeof r && (e.style.cssText = r = ""), r))
          for (t in r) (n && t in n) || ln(e.style, t, "");
        if (n) for (t in n) (r && n[t] === r[t]) || ln(e.style, t, n[t]);
      }
    else if ("o" === t[0] && "n" === t[1])
      (a = t !== (t = t.replace(/Capture$/, ""))),
        ...
        (e.l[t + a] = n),
        n
          ? r || e.addEventListener(t, a ? dn : fn, a)
          : e.removeEventListener(t, a ? dn : fn, a);
  ...
  function fn(e) {
    return this.l[e.type + !1](Ut.event ? Ut.event(e) : e);
  }
  function dn(e) {
    return this.l[e.type + !0](Ut.event ? Ut.event(e) : e);
  }
  function _n(e, t, n, r, o, a, i, c, s) {
    var l,
      u,
      f,
      d,
      ...
      e: if ("function" == typeof S) {
        if (
          ...
          null != S.getDerivedStateFromProps &&
            (u.__s == u.state && (u.__s = Gt({}, u.__s)),
            Gt(u.__s, S.getDerivedStateFromProps(m, u.__s))),
          (d = u.props),
          (_ = u.state),
          (u.__v = t),
          f)
          ...
          if (
            ...
            for (
              t.__v !== n.__v &&
                ((u.props = m), (u.state = u.__s), (u.__d = !1)),
                u.__e = !1,
                t.__e = n.__e,
                t.__k = n.__k,
        ...
        (u.state = u.__s),
          null != u.getChildContext && (r = Gt(Gt({}, r), u.getChildContext())),
          f ||
            null == u.getSnapshotBeforeUpdate ||
            (g = u.getSnapshotBeforeUpdate(d, _)),
          (E =
            null != l && l.type === Xt && null == l.key ? l.props.children : l),
          rn(e, Array.isArray(E) ? E : [E], t, n, r, o, a, i, c, s),
          (u.base = t.__e),
          (t.__h = null),
        ...
        null == a && t.__v === n.__v
          ...
          : (t.__e = (function (e, t, n, r, o, a, i, c) {
              var s,
                l,
                u,
                f = n.props,
              ...
              if (null === _) f === d || (c && e.data === d) || (e.data = d);
              else {
                if (
                  ((a = a && Wt.call(e.childNodes)),
                  (l = (f = n.props || Ft).dangerouslySetInnerHTML),
                ...
                if (
                  ...
                  for (g = a.length; g--; ) null != a[g] && Jt(a[g]);
                c ||
                  ("value" in d &&
                    void 0 !== (g = d.value) &&
                    (g !== e.value ||
                      ("progress" === _ && !g) ||
                      ("option" === _ && g !== f.value)) &&
                    un(e, "value", g, f.value, !1),
                  "checked" in d &&
                    void 0 !== (g = d.checked) &&
                    g !== e.checked &&
                    un(e, "checked", g, f.checked, !1));
              }
              return e;
            })(n.__e, t, n, r, o, a, i, s));
      (l = Ut.diffed) && l(t);
  ...
  function mn(e, t, n) {
    var r, o;
    if (
      (Ut.unmount && Ut.unmount(e),
      (r = e.ref) && ((r.current && r.current !== e.__e) || pn(r, null, t)),
      null != (r = e.__c))
    ) {
    ...
    if ((r = e.__k))
      for (o = 0; o < r.length; o++)
        r[o] && mn(r[o], t, n || "function" != typeof e.type);
    n || null == e.__e || Jt(e.__e), (e.__ = e.__e = e.__d = void 0);
  }
  function hn(e, t, n) {
    ...
    return (
      ...
      (function (e, t, n) {
        ...
        if (
          ...
          yn.u = !0;
          var a = yn.shouldComponentUpdate,
            i = yn.componentWillUpdate;
          (yn.componentWillUpdate = function (e, t, n) {
            if (this.__e) {
              var r = a;
  ...
  function jn(e, t) {
    var n = Ln(vn++, 3);
    !Ut.__s && Mn(n.__H, t) && ((n.__ = e), (n.i = t), yn.__H.__h.push(n));
  }
  function Pn(e) {
    return (
      (kn = 5),
  ...
  function Dn() {
    for (var e; (e = En.shift()); )
      if (e.__P && e.__H)
        try {
          e.__H.__h.forEach(Wn), e.__H.__h.forEach(Un), (e.__H.__h = []);
        } catch (t) {
          (e.__H.__h = []), Ut.__e(t, e.__v);
        }
  }
  (Ut.__b = function (e) {
    (yn = null), xn && xn(e);
        ...
        (wn === yn
          ? ((t.__h = []),
            ...
            t.__.forEach(function (e) {
              e.__N && (e.__ = e.__N), (e.__V = Sn), (e.__N = e.i = void 0);
            }))
          : (t.__h.forEach(Wn), t.__h.forEach(Un), (t.__h = []))),
        (wn = yn);
    }),
    (Ut.diffed = function (e) {
      ...
      t &&
        t.__H &&
        (t.__H.__h.length &&
          ((1 !== En.push(t) && bn === Ut.requestAnimationFrame) ||
            ((bn = Ut.requestAnimationFrame) || In)(Dn)),
  ...
  var Rn = "function" == typeof requestAnimationFrame;
  function In(e) {
    var t,
      n = function () {
        clearTimeout(r), Rn && cancelAnimationFrame(t), setTimeout(e);
      },
      r = setTimeout(n, 100);
    Rn && (t = requestAnimationFrame(n));
  }
  function Wn(e) {
    var t = yn,
      n = e.__c;
    "function" == typeof n && ((e.__c = void 0), n()), (yn = t);
  }
  function Un(e) {
    var t = yn;
    (e.__c = e.__()), (yn = t);
  ...
  ((Bn.prototype = new Zt()).isPureReactComponent = !0),
  ...
  (Ut.unmount = function (e) {
    var t = e.__c;
    t && t.__R && t.__R(), t && !0 === e.__h && (e.type = null), $n && $n(e);
  }),
    ((Jn.prototype = new Zt()).__c = function (e, t) {
      var n = t.__c,
        r = this;
      ...
      var c = function () {
          if (!--r.__u) {
            if (r.state.__a) {
              var e = r.state.__a;
              r.__v.__k[0] = Gn(e, e.__c.__P, e.__c.__O);
            }
            var t;
        ...
        s = !0 === t.__h;
      r.__u++ || s || r.setState({ __a: (r.__b = r.__v.__k[0]) }), e.then(i, i);
    }),
    ...
    (Jn.prototype.render = function (e, t) {
      ...
      var o = t.__a && Yt(Xt, null, e.fallback);
      return o && (o.__h = null), [Yt(Xt, null, t.__a ? null : e.children), o];
    });
  ...
  ((Kn.prototype = new Zt()).__a = function (e) {
    var t = this,
      n = Yn(t.__v),
      r = t.o.get(e);
    return (
    ...
    (Kn.prototype.render = function (e) {
    ...
    (Kn.prototype.componentDidUpdate = Kn.prototype.componentDidMount =
      function () {
        var e = this;
  ...
  var Zn =
    ...
    er = /^on(Ani|Tra|Tou|BeforeInp|Compo)/,
    tr = /[A-Z0-9]/g,
  ...
  Ut.event = function (e) {
    return (
      or && (e = or(e)),
      (e.persist = ar),
      (e.isPropagationStopped = ir),
      (e.isDefaultPrevented = cr),
      (e.nativeEvent = e)
    );
  };
  var sr = {
    ...
    "string" == typeof e.type &&
      (function (e) {
          ...
          if (
            ...
            "defaultValue" === o && "value" in t && null == t.value
              ...
              ? "onfocus" === i
                ...
                : er.test(o)
                ? (o = i)
                : -1 === n.indexOf("-") && Qn.test(o)
                ? (o = o.replace(tr, "-$&").toLowerCase())
                : null === a && (a = void 0)
              : (i = o = "oninput"),
        ...
        "select" == n &&
          ...
          (r.value = an(t.children).forEach(function (e) {
  ...
  var dr = [
    {
      ...
      defaultValues: {
        ...
        opts: { close_outside_click: !1 },
      },
    },
    {
      name: "toggle",
      editableProps: ["full_name", "color"],
      defaultValues: { style: { full_name: !1, color: "#3D46FB" } },
    },
    {
      name: "underline_edge",
      editableProps: ["full_name", "color"],
      maxLanguages: 10,
      minLanguages: null,
      defaultValues: { style: { full_name: !1, color: "#FA8072" } },
    },
    {
      name: "underline_full",
      maxLanguages: 10,
  ...
  function gr(e) {
    ...
    return n && n.custom_local_name
      ...
      : n && n.custom_name
      ? n.custom_name
      : t === et.language_from && et.language_from_custom_name
  ...
  function mr(e, t) {
    return "WordPress" === et.technology_name &&
      et.injectedData &&
      !et.is_connect
      ? t(et.injectedData.switcher_links[e])
      : Ue(e, t);
  }
  var hr = ["none", "shiny", "square", "circle", "rectangle_mat"];
  function vr(e) {
    return e
  ...
  var yr,
      ...
      var r = (function (e) {
          return (function (e, t, n) {
            ...
            if (t.language_from === e)
              return t.language_from_custom_flag || pr(e, n);
            var r = e.toLowerCase(),
            ...
            return o ? o.custom_flag || pr(o.language_to, n) : "";
          })(e, et, _r);
        })(t),
        o = kr[n] || {},
        a = o.width,
      ...
      if (r)
        return Yt("img", {
          src:
            r.indexOf("http") > -1
              ? r
              : "https://cdn.weglot.com/flags/" + n + "/" + r + ".svg",
          width: a,
          height: i,
          className: "wg-flag",
          role: "none",
    ...
    Sr = function (e) {
      ...
      var f = t.with_flags,
        d = t.flag_type,
        _ = u ? gr(n) : n.toUpperCase(),
        g = c ? "div" : "li",
        p = hr.indexOf(d || "rectangle_mat"),
        m = f ? " wg-flags" + (o ? " flag-" + p + " legacy" : "") : "",
        h = i && !c ? " focus" : "",
        v = c ? " wgcurrent" : "";
      return Yt(
        g,
        ...
        Yt(
          ...
          Object.assign(
            {},
            c ? { tabIndex: -1, target: "_self" } : { role: "option" },
            { href: a },
            !l && { "aria-label": _ },
            i && !c && { ref: s },
            { id: "weglot-language-" + n }
          ),
          f && !o && Yt(Er, { language: n, flagType: d }),
          l && _
        )
      );
    },
    xr = (function (e, t) {
      return function (t) {
        ...
        var a = (function (e) {
            ...
            void 0 === r && (r = {});
            var o = n.opts;
            return void 0 === o && (o = {}), { style: r, opts: o };
          })("default"),
          i = a.style,
          c = a.opts,
        ...
        return (
          (function (e, t, n) {
            ...
            Ut.__ && Ut.__(e, t),
              ...
              _n(
                t,
                (e = t.__k = Yt(Xt, null, [e])),
                o || Ft,
                Ft,
                void 0 !== t.ownerSVGElement,
                o ? null : t.firstChild ? Wt.call(t.childNodes) : null,
                a,
            ...
            Yt(e, {
              style: Object.assign({}, i, r),
              opts: Object.assign({}, c, o),
            }),
            s
          ),
          s.classList.add("weglot-container"),
          s
        );
      };
    })(function (e) {
      var t = e.style,
        ...
        i = (function () {
          var e = An(
              "WordPress" === et.technology_name &&
                et.injectedData &&
                !et.is_connect
                ? et.injectedData.current_language
                : et.switcher_editor
                ? et.language_from
        ...
        h = m[0],
        v = m[1],
        y = t.is_dropdown || t.invert_flags,
        w = lt().filter(function (e) {
          return !y || e !== c;
        }),
        b = et.switcher_editor,
        k = et.close_switcher_outside_click,
        E = n.close_outside_click,
        S =
          /background-position/i.test(et.button_style.custom_css) &&
          !et.languages.some(function (e) {
        ...
        C = Pn(null),
        O = t.is_dropdown ? "wg-drop" : "wg-list",
        N = o ? "open" : "closed",
        T = u && o ? " weg-openup" : "",
        L = _ && o ? " weg-openleft" : "",
        A = b ? " wg-editor" : "";
      function j() {
        ...
        var n = e.bottom;
        void 0 === n && (n = 0),
          g(t > window.innerWidth / 2),
          f(n > window.innerHeight / 2),
          a(!0);
      }
      function P() {
        a(!1), v(null);
      ...
      function R(e) {
        if (et.switcher_editor) return a(!1);
        var t;
        s(e),
          (t = e),
          "WordPress" === et.technology_name &&
      ...
      function I(e) {
        p.current && !p.current.contains(e.target) && P();
      }
      return (
        jn(
          function () {
            h && C.current.scrollIntoView({ block: "center" });
          },
          [h]
        ),
        jn(function () {
        ...
        Yt(
          "aside",
          {
                ...
                ? (e.preventDefault(),
                  void (function (e) {
                    var t = 40 === e ? "down" : "up",
                      n = w.slice(-1).pop(),
                      r = w[0],
                      a = vr(p.current).bottom;
                    void 0 === a && (a = 0);
                    var i = a > window.innerHeight / 2;
                    if (!h || !o)
                      return (
                        v("down" === t ? r : n),
                        void (
                    ...
                    if (
                      ...
                      var c = "up" === t ? -1 : 1,
                        s = w.indexOf(h) + c;
                      s !== w.length && -1 !== s && v(w[s]);
                    }
                  })(e.keyCode))
                : void (27 === e.keyCode && o && (e.preventDefault(), D()));
            },
            ...
            className:
              ...
              L +
              A,
            "aria-label": "Language selected: " + gr(c),
          },
          y &&
            Yt(Sr, {
              styleOpts: t,
          ...
          Yt(
            "ul",
            { role: "none", style: !o && t.is_dropdown && { display: "none" } },
            w.map(function (e) {
              return Yt(Sr, {
                language: e,
                url: e === c ? "#" : x[e],
  ...
  function Nr(e, t) {
    if ((void 0 === t && (t = document.documentElement), e && !e.ready)) {
      var n = e.style || et.button_style,
        r = xr(Object.assign({}, e, !et.switcher_editor && { style: n }));
      if (
        ((r.weglotSwitcher = e), Or.push(r), !e.location || !e.location.target)
      )
        return (
      ...
      var o = Z(t, e.location.target);
      if (o) {
        if (
          (r.setAttribute("data-switcher-id", String(++Cr)),
          (r.id = "weglot-switcher-" + Cr),
          r.setAttribute("data-switcher-style-opt", JSON.stringify(n)),
          e.location.sibling)
        ) {
          var a = Z(t, e.location.sibling);
          try {
            o.insertBefore(r, a);
          } catch (e) {
            o.contains(a) ||
        ...
        } else o.insertBefore(r, null);
        e.ready = !0;
        for (
          var i = 0, c = t.querySelectorAll(".weglot-container:empty");
          i < c.length;
          i += 1
        )
          te(c[i]);
  ...
  function Tr(e) {
    ...
    if (
      (void 0 === r && (r = !1),
      Z(document.documentElement, "script#weglot-switcher-" + t))
    )
      return !1;
    var o = !et.switcher_editor && n ? t + "." + n : t,
  ...
  function Lr() {
    yr || ve("switchersReady", Oe()),
      (yr = !0),
      clearTimeout(br),
      wr && wr.parentNode.removeChild(wr);
  }
  function Ar(e) {
    if (
      (void 0 === e && (e = document), !(lt().length < 2 || et.hide_switcher))
    ) {
      ...
      (function (e) {
        if (
          ...
          0 !==
            X(e, 'a[href^="#Weglot-"],a[href*="change-language.weglot.com/"]')
              .length)
        ) {
          for (
            var t = lt(),
                    ...
                    var s = function () {
                        ...
                        e.setAttribute(U, ""),
                          ...
                          e.addEventListener("click", function (e) {
                            e.preventDefault(), e.stopPropagation(), ro(t);
                          });
                      },
                      l = 0,
                      u = a;
              ...
              function (e) {
                for (var t = 0, n = o; t < n.length; t += 1) {
                  var r = n[t],
                    ...
                    i = r.links;
                  if (a === e)
                    for (var c = 0, s = i; c < s.length; c += 1)
                      s[c].classList.add("weglot-link--active");
                  else
      ...
      for (var c = 0, s = et.switchers; c < s.length; c += 1) {
        var l = s[c];
        if (!l.default) {
          var u = l.template;
          if (u) {
      ...
      if (!yr && !wr) {
        var d = et.switchers.find(function (e) {
          return e.default;
        }) || { style: et.button_style };
        br = setTimeout(function () {
          (wr = Nr(d)), ve("switchersReady", Oe());
        });
      }
    }
  }
  he(
    ...
    function () {
      Or.forEach(function (e) {
        ...
        (wr = null),
        (Cr = 0),
        (et.button_style.ready = !1),
        et.switchers.map(function (e) {
          return (e.ready = !1);
        }),
        Ar();
    },
  ...
  function Pr() {
    var e = ["name", "value"];
    et.translate_event.forEach(function (t) {
      for (
        var n = X(document.body, t.selector),
          r = function () {
            var n = a[o];
            ...
            (r.name = ""),
              ...
              new MutationObserver(function (t) {
                for (var o = 0, a = t; o < a.length; o += 1) {
                  var i = a[o],
                    c = n.getAttribute(i.attributeName);
                  e.includes(i.attributeName) &&
                    r.setAttribute(i.attributeName, c);
                }
              }).observe(n, { attributes: !0 });
            var i = le(function (e) {
              13 === e.keyCode && e.target.form
                ? e.target.form.dispatchEvent(new Event("submit"))
                : Rt(e.target.value, function (e) {
  ...
  try {
    var Dr = Element.prototype.attachShadow;
    Element.prototype.attachShadow = function (e) {
      var t = Dr.call(this, e);
      return Rr([this]), t;
    };
  } catch (Pn) {}
  function Rr(e) {
    if (et.translate_shadow_roots) {
      e ||
        (e = X(
          document,
          et.dynamics
      ...
      for (var t = 0, n = e; t < n.length; t += 1) {
        ...
        if (r.shadowRoot && !r.shadowRoot.wgTranslated) {
          (r.shadowRoot.wgTranslated = !0), Fr(r.shadowRoot);
          var o = Ct(r.shadowRoot);
          o.length && (Nt(o), Gr(o));
        }
      }
    }
  ...
  function Br(e, t) {
    ...
    try {
                      ...
                      Ur.length &&
                        (Ir = setTimeout(function () {
                          Ar(e),
                            ...
                            Rr(Ur),
                            _e("onDynamicDetected"),
                            (Ur = []);
                        }, 100));
                    })(a, r);
                  }),
                  !Wr || !a || !Q(a, Wr))
                : !Mr.includes(e.attributeName) &&
                  t(a) &&
            ...
            for (
                ...
                o = function (e) {
                  ...
                  if (e.wgParsed !== n) {
                    ...
                    for (
                      ...
                      var i = a[o];
                      (et.ignoreDynamicFragments &&
                        !document.body.contains(i)) ||
                        (i.weglot.dynamic || (i.weglot.dynamic = 0),
                        i.weglot.dynamic++,
                        r.push(i));
                    }
                  }
              ...
              switch (l) {
                ...
                case "childList":
                  ...
                  for (var _ = 0, p = f; _ < p.length; _ += 1) {
                    var m = p[_],
                      h = [];
                    "IFRAME" === m.tagName
                      ? (h = [m])
                      : m.querySelectorAll &&
                        (h = m.querySelectorAll("iframe"));
      ...
      R.warn(e, { consoleOverride: "Error in MutationObserver" });
    }
  }
  var zr = !1;
  function Fr(e) {
    var t = e !== document ? e : e.body || e,
      n = new MutationObserver(function (t) {
        ...
        if (zr) Br(t, e);
          ...
          var r = qr.find(function (t) {
            return t.documentElement === e;
          });
          r
            ? (n = r.mutations).push.apply(n, t)
            : qr.push({ documentElement: e, mutations: [].concat(t) });
        }
      });
    n.observe(t, {
      childList: !0,
  ...
  function $r(e) {
    return (
      !(!et.dynamics || 0 === et.dynamics.length) &&
  ...
  var Vr = { times: [], timeout: null, nodes: [] };
  function Gr(e) {
    void 0 === e && (e = []), clearTimeout(Vr.timeout);
    var t = Oe();
    if (t !== et.language_from) {
      if (
        ((Vr.times = Vr.times.filter(function (e) {
          return e > Date.now() - 1e3;
        })),
        Vr.times.length && (Vr.timeout || Vr.times.length >= 10))
      )
        return (
          (Vr.nodes = Vr.nodes.concat(e)),
          void (Vr.timeout = setTimeout(function () {
            return Gr();
          }, 1e3))
        );
      (Vr.timeout = null), Vr.times.push(Date.now());
      var n = Vr.nodes.concat(e);
      return (
        (Vr.nodes = []),
        Dt(Tt(n), t, { title: !1, cdn: !0, nodes: n }).then(function (e) {
          return Lt(e, t, n);
        })
      );
    }
  ...
  function Jr() {
    var e = ee("wg_progress").firstElementChild,
  ...
  function Yr(e) {
    clearInterval(e), te(ee("wg_progress"));
  }
  var Kr,
    Xr,
    Zr,
  ...
  function eo(e) {
    if (e.data && "null" !== e.origin) {
      ...
      if (n) {
        if ("Weglot.iframe" === n) {
          var o = { message: "Weglot.setLanguage", payload: Oe() };
          return e.source.postMessage(o, e.origin), void Qr.push(e.source);
        }
        "Weglot.setLanguage" !== n || ro(r);
      }
    }
  }
  function to(e) {
    void 0 === e && (e = Oe());
    for (
      var t = { message: "Weglot.setLanguage", payload: e }, n = 0, r = Qr;
      n < r.length;
      n += 1
    ) {
      var o = r[n];
  ...
  function oo(e, t) {
    if (!lt().includes(e))
      return (
        ht(),
        void R.warn(e + " isn't a language you have added", {
          sendToDatadog: !1,
        })
      );
    et.auto_switch && _t(e);
    var n = st();
    if ((et.is_connect || n || mt(e), !ao(e))) {
      if (et.loading_bar)
        var r = (function () {
          try {
            var e = document.createElement("div");
      ...
      if (e === et.language_from)
        return (
          _e("onPageLanguageSet", e),
          ht(),
          Lt(null, e),
          et.loading_bar && Yr(r),
          document.documentElement.setAttribute("lang", e),
          void ve("languageChanged", e, t || "")
        );
      Dt(Tt(), e)
        .then(function (n) {
          ht(),
            Lt(n, e),
            document.documentElement.setAttribute("lang", e),
            ve("languageChanged", e, t || ""),
            et.loading_bar && Yr(r);
        })
        .catch(function (e) {
          throw (et.loading_bar && Yr(r), ht(), Ae().removeItem(I), e);
        }),
        _e("onPageLanguageSet", e);
    }
  }
  ...
  he(
    ...
    function () {
      et.translate_search &&
        ...
        (function () {
          for (
            var e = et.search_forms,
              t = et.search_parameter,
              n = 0,
              r = X(document, e);
            n < r.length;
            n += 1
            ...
            -1 !== window.location.search.indexOf(t + "=") &&
              o.elements &&
              o.elements[t] &&
              (a = ge.get("wg-search-form")) &&
              (o.elements[t].value = a);
          }
          ge.erase("wg-search-form");
        })();
    },
    !0
  );
  ...
  function co() {
    ...
    (e.name = "google"),
      ...
      document.documentElement &&
        -1 ===
          ["cms.e.jimdo.com", "proxy.weglot.com"].indexOf(
  ...
  function so() {
    if (et.api_key) {
      he(
        "initialized",
        function () {
          et.page_views_enabled &&
            (et.is_connect
              ? Ue(et.language_from, function (e) {
                  return gt(e);
                })
              : gt());
        },
      ...
      if ((_e("onWeglotSetup"), !fo.initialized || window.Turbolinks)) {
        (Xr = (function () {
          var e = lt();
          if (et.is_connect) {
            var t =
              document.documentElement.dataset.wgTranslated ||
              (et.subdirectory ? Ce() : xe());
            if (t !== et.language_from) return t;
            if (!et.subdirectory && et.technology_name === B) {
              var n = ge.get("wg_checkout_language");
              if (n && e.includes(n))
                return ge.erase("wg_checkout_language"), n;
            }
            var r = dt();
            return t === et.language_from && r && e.includes(r)
              ? r
              : et.language_from;
          }
          var o = re("lang");
          if (o && e.includes(o)) return (io = !0), o;
          var a = pt();
          if (a && e.includes(a)) return a;
          var i = dt();
          return i && e.includes(i) ? ((io = !0), i) : et.language_from;
        })()),
          Oe();
        var e = st();
        if (
          ((Zr =
            Xr &&
            Xr !== et.language_from &&
            document.documentElement.dataset.wgTranslated !== Xr &&
            !e &&
            !document.documentElement.dataset.wgExcludedUrl &&
            !et.switcher_editor) && et.wait_transition
            ? oe(
        ...
        !(function (e, t, n) {
          if (n || !e || window.top !== window || !ao(e)) {
            ...
            if (
              ...
              !et.is_connect ||
              et.dynamicPushState ||
              (!o && e !== et.language_from)
                ? (function (e) {
                    void 0 === e && (e = !0);
                    var t = et.excluded_blocks,
                      n = et.is_connect;
                    if ((zr = e))
                      if (
                        ((Wr =
                          ...
                          var r = function () {
                              var e = a[o],
                                ...
                                r = function () {
                                  ...
                                  e.length > 0 && (Br(e, n), setTimeout(r, 0));
                                };
                              r();
                            },
                            o = 0,
                ...
                : (function () {
                    if (0 !== Hr.length) {
                      for (var e = 0, t = Hr; e < t.length; e += 1)
                        t[e].disconnect();
                      qr = [];
                    }
                  })(),
              ...
              (et.is_connect && !o && _e("onConnectPageLoad", e),
              et.force_translation)
            ) {
              for (var a = [], i = 0, c = r; i < c.length; i += 1) {
                var s = c[i];
                ((s.closest && s.closest(et.force_translation)) ||
                  (!s.closest &&
                    s.parentNode &&
                    s.parentNode.closest &&
                    s.parentNode.closest(et.force_translation))) &&
                  a.push(s);
              }
              Gr(a);
            }
            (o && !o.language_button_displayed && o.allExcluded) || Ar(),
              o ||
                (et.remove_unused_link_hooks &&
                  (function () {
                    var e = lt(),
                      t = et.languages
                        .map(function (e) {
                    ...
                    1 === e.length && t.push(et.language_from);
                    for (
                      var n = t
                          .map(function (e) {
                            return It(e);
                ...
                Pr(),
                (function () {
                  window.addEventListener("message", eo, !1);
                  var e = et.translate_iframes;
                  if (e)
                    for (
                      var t = 0, n = X(document.body, e);
                      t < n.length;
                      t += 1
                    ) {
                      var r = n[t];
                      r.contentWindow && Qr.push(r.contentWindow);
                    }
                  de("onPageLanguageSet", to),
                    "with-window-top" === no() &&
                ...
                ["alert"].forEach(function (e) {
                  ...
                  window[e] = function () {
                    ...
                    if ("string" == typeof arguments[0]) {
                      var n = Oe();
                      return et.language_from === n
                        ? t.apply(window, arguments)
                        : Dt([{ t: 2, w: arguments[0] }], n, {
                            title: !1,
                            cdn: !0,
                          }).then(function (n) {
          ...
          case "Weglot.detect":
            e.source.postMessage(
              JSON.stringify({
                ...
                data: { initialized: fo.initialized, options: et },
              }),
              e.origin
            );
            break;
  ...
  var fo = window.Weglot || {
    ...
    off: function (e, t) {
      var n,
        r = !1,
        o = function (t) {
          return pe[t].name === e && !pe[t].internal;
        };
      n =
        "function" == typeof t
          ? function (e) {
              return o(e) && pe[e].callback === t;
            }
          : function (e) {
              return o(e);
            };
      for (var a = pe.length - 1; a >= 0; a--)
        n(a) && (pe.splice(a, 1), (r = !0));
      return r;
    },
    getStoredLang: pt,
    getLanguageName: gr,
    ...
    translate: function (e, t) {
      ...
      if (
        ...
        return (
          R.error(o, { sendToDatadog: !1 }), t && t(null, o), Promise.reject()
        );
      }
      return r === et.language_from
        ? (t &&
  ...
  return (
    me(ot(), "polyfillReady", function () {
      ...
      if (n) {
        ...
        r && 0 === r.indexOf("wg_") && fo.initialize({ api_key: r });
      }
    }),
    fo
  );
